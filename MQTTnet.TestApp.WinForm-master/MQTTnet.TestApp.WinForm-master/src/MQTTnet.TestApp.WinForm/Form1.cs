    ...
    public partial class Form1 : Form
    {
        ...
        private async void ButtonPublisherStartClick(object sender, EventArgs e)
        {
            ...
            var options = new MqttClientOptions
            {
                ...
                {
                    Server = "eu1.cloud.thethings.network", Port = int.Parse(this.TextBoxPort.Text.Trim()), TlsOptions = tlsOptions
                }
            };
            ...
            {
                Username = "lora-sensor-mesh-stack-test@ttn", Password = Encoding.UTF8.GetBytes("NNSXS.E2M5LEHSSON5W2NGGXFTTPMHXBC7MI3LVKHBEGY.DIS3NNQBOMBAHVRR57TGAQP5CQJMEZFO5EN6PUJRC3ZKK6UBF5LQ")
            };
